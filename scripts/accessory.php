  ...
  <body>
    ...
    <div id="products" class="container products mb-5 mt-5">
        <div class="products__category grid">
                ...
                <div class="products__category-item">
                    <img  src="../assets/img/accessory.png" class="product-img img-inactive"/>
                     <h4 class="inactive mb-5 fw-bold">АКСЕССУАРЫ
                        <div class="line"></div>
                     </h4>
                </div>
            <a class="no-style" href="healthcare.php#products">
              <div class="products__category-item">
                ...
                <?php 
                  ...
                  if($result = $link->query($sql)){
                    ...
                    foreach($result as $row){
                        echo "<div class='products__item mb-5 grid'>
                        <img src='../assets/upload/" . $row["pic_path"] . "' class='products__item-img img-fluid' alt=''>
                        <div class='products__item-txt'>
                        <h3>" . $row["name"] . "</h3>
                        <p>" . $row["desc"] . " </p>
                        </div>
                        <p class='products__item-cost'>" . $row["cost"] . " Р </p>
        ...
        <p>
          ...
          <form method="POST" class="container news">
            <h3 class="news-title">Свяжитесь с нами!</h3>
                ...
                <input type="submit" onclick="return clicked();" class="btn btn-primary btn-block send" value="Отправить" name="submit">
        </form>
</div>

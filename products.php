    ...
    <div class="container products mb-5 mt-5">
        ...
        <div style="margin: 5rem 0;" class="products__catalogue grid">
            ...
            <div class="products__catalogue-items">
                ...
                <?php 
                  $link = mysqli_connect("localhost", "root", "", "petscop");
                  $sql = "SELECT `pic_path`, `name`, `desc`,`cost` FROM `food` WHERE `sale`>=200
                  UNION SELECT `pic_path`, `name`, `desc`,`cost` FROM `toys` WHERE `sale`>=200
                    UNION SELECT `pic_path`, `name`, `desc`,`cost` FROM `accessory` WHERE `sale`>=200
                    UNION SELECT `pic_path`, `name`, `desc`,`cost` FROM `healthcare` WHERE `sale`>=200";

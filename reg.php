...
$link = mysqli_connect("localhost", "root", "", "petscop");

if (isset($_POST["first_name"])) {
  //Вставляем данные, подставляя их в запрос
  $sql = mysqli_query($link, "INSERT INTO `users` (`first_name`, `last_name`, `email`, `passw`) VALUES ('{$_POST['first_name']}', '{$_POST['last_name']}', '{$_POST['email']}', '{$_POST['passw']}')");
...
<html lang="en">
  ...
  <body>
    ...
    <header class="gradient-3 login">
        ...
        <form action="login.php" style="width: 600px;" method="POST" class="mt-5 container news">
                <div class="form-group mb-2">
                    <input type="text" class="mt-3 form-control" placeholder="Ваше имя" name="first_name">
                </div>
                <div class="form-group mb-2">
                    <input type="text" class="mt-3 form-control" placeholder="Ваша фамилия" name="last_name">
                </div>
                <div class="form-group mb-2">
                    <input type="text" class="mt-3 form-control" placeholder="Email" name="email">
                </div>
                <div class="form-group mb-2">
                    <input type="password" class="mt-3 form-control" placeholder="Придумайте пароль" name="passw">
                </div>
                <input type="submit" class="mt-5 mb-5 btn btn-primary btn-block send" value="Зарегистрироваться" name="submit">
        </form>
    </header>
